...
async def debug():
    async with async_playwright() as p:
        ...
        url = "https://www.bing.com/search?q=site:x.com+dengue+Karachi"
        ...
        print(f"Total result elements found on Bing: {len(results)}")
        ...
        if len(results) == 0:
            ...
            for idx, res in enumerate(results[:3]):
                ...
                snippet = res.select_one("p") or res.select_one("div.b_caption")
                print(f"\n--- Result {idx + 1} ---")
