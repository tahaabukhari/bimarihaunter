...
joblib.dump(model, os.path.join(os.path.dirname(__file__), "..", "news_classifier.joblib"))
joblib.dump(vectorizer, os.path.join(os.path.dirname(__file__), "..", "tfidf_vectorizer.joblib"))
print(f"      Model saved   -> {MODEL_PATH}")
print(f"      Vectorizer    -> {VEC_PATH}")
print(f"      Model (joblib) saved -> {os.path.join(os.path.dirname(__file__), '..', 'news_classifier.joblib')}")
print(f"      Vectorizer (joblib) saved -> {os.path.join(os.path.dirname(__file__), '..', 'tfidf_vectorizer.joblib')}")
